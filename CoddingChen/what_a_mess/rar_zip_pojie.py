...
def main():
    x = Passward(filename="./情书.zip", target_path="./")
    x.brutal_extract([4,5,6,7,8], digit=True, lower=True, upper=True, punctuation=False)
